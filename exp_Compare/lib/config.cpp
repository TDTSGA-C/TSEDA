...
//    Resource Rsc_2 = Resource(0, 2, 2);
    ...
    int TskIndex = 0;
    int RscIndex = 0;
    string RscAlcPath = FilePath + "/" + RscAlcFile;
...
void ConfigParameter_TSEDA() {
    Parameter_TSEDA.NumOfChormPerPop = Tasks.size()*2;
    ...
    Parameter_TSEDA.NumOfEliteOfPop =  ceil(Parameter_TSEDA.NumOfChormPerPop * 0.05);
    Parameter_TSEDA.NumOfImproveOfPop= ceil(Parameter_TSEDA.NumOfChormPerPop * 0.2);
    Parameter_TSEDA.RunTimeRatioOfStg1 = 0.7;
}
