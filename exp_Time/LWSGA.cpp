//
// Created by smallfish on 18-9-3.
//
#include "common.h"
#include "tools.hpp"
#include "config.h"
...
//    int terminationNum = ceil( 60*ModelScale/Parameter_LWSGA.NumOfChormPerPop );
    int terminationNum = ceil( 260*ModelScale/pow(comConst.NumOfTsk, 1.0 / 3)/Parameter_LWSGA.NumOfChormPerPop );
//    int terminationNum = ceil(300*ModelScale/sqrt(comConst.NumOfTsk)/Parameter_LWSGA.NumOfChormPerPop);
    int NumOfNoImpGen = 0;
    while (1) {
        ++iteration;
