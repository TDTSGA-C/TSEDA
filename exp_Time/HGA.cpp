//
// Created by smallfish on 18-8-7.
//
...
//    int terminationNum = ceil( 60*ModelScale/Parameter_HGA.NumOfChormPerPop );
    int terminationNum = ceil( 260*ModelScale/pow(comConst.NumOfTsk, 1.0 / 3)/Parameter_HGA.NumOfChormPerPop );
//    int terminationNum = ceil( 300*ModelScale/sqrt(comConst.NumOfTsk)/Parameter_HGA.NumOfChormPerPop );
    int NumOfNoImpGen = 0;
    while (1) {
        ++iteration;
