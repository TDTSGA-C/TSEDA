...
void ConfigParameter_TSEDA(Orthogonal orthogonal) {
    Parameter_TSEDA.NumOfChormPerPop = Tasks.size() * orthogonal.NumOfChormPerPopRate;
    if (Parameter_TSEDA.NumOfChormPerPop % 2 == 1) {
        ++Parameter_TSEDA.NumOfChormPerPop;
    }
    Parameter_TSEDA.NumOfEliteOfPop =  ceil(Parameter_TSEDA.NumOfChormPerPop * orthogonal.NumOfEliteOfPopRate);
    Parameter_TSEDA.NumOfImproveOfPop= ceil(Parameter_TSEDA.NumOfChormPerPop * orthogonal.NumOfImproveOfPopRate);
    Parameter_TSEDA.RunTimeRatioOfStg1 = orthogonal.RunTimeRatioOfStg1Rate;
    Parameter_TSEDA.alpha = orthogonal.alpha;
    Parameter_TSEDA.beta = orthogonal.beta;
}
